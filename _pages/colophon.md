...
<div class="man-body">
<a class="inline-cmd" href="/experience/" data-cmd="git log experience"><code>git log experience</code></a>,
<button type="button" class="inline-cmd" data-cmd="--carrots"><code>--carrots</code></button>,
<a class="inline-cmd" href="{{ site.strava_url }}" rel="external noopener"><code>strava</code></a>,
<a class="inline-cmd" href="{{ site.goodreads_url }}" rel="external noopener"><code>goodreads</code></a>
</div>
